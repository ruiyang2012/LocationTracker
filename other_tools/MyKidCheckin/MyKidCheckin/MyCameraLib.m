...
@interface MyCameraLib() <AVCaptureMetadataOutputObjectsDelegate>
...
- (void) onSessionReady {
  ...
  [self setVideoDevice:[MyCameraLib device]];
...
- (void)focusAtPoint:(id) sender{
  CGPoint touchPoint = [(UITapGestureRecognizer*)sender locationInView:_preview];
